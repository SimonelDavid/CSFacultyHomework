...
def srv_adauga_cheltuiala(l, istoric, zi, suma, tip, mod):
...
def ui_adauga_cheltuiala(l, istoric, mod):
    ...
    srv_adauga_cheltuiala(l, 0, zi, suma, tip, 0)
    if mod == 1:
        srv_adauga_istoric(istoric, 0, zi, suma, tip)
    ...
    if len(l) == 0:
        ...
        for cheltuiala in l:
            if get_ziua(cheltuiala) == zi and get_tip(cheltuiala) == tip:
                ...
                srv_adauga_cheltuiala(l1,0,z,s,tip,0)
    ...
    if len(l) == 0:
        ...
        for cheltuiala in l:
            if get_ziua(cheltuiala) == zi and get_tip(cheltuiala) == tip:
                ...
                srv_adauga_cheltuiala(l1,0,zi,s,tip,0)
                if mod == 1 or mod == 2:
    ...
    if len(l) == 0:
        ...
        for cheltuiala in l:
            if get_ziua(cheltuiala) == zi and get_tip(cheltuiala) == tip:
                ...
                srv_adauga_cheltuiala(l1,0,zi,s,t,0)
