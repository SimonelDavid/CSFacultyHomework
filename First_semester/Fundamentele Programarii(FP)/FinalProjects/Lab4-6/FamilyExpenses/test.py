...
from citire import creeaza_cheltuiala, modificare_suma, modificare_tip, modificare_zi, srv_adauga_cheltuiala
from stergere import sterge_cheltuiala_de_un_anumit_tip, sterge_cheltuiala_din_interval, sterge_cheltuiala_dupa_zi, sterge_cheltuiala_dupa_zi_si_tip, sterge_ultima_inregistrare_din_istoric
...
def test_stergere_cheltuieli_dupa_zi():
    ...
    assert(sterge_cheltuiala_dupa_zi(l, 0, 12, 0) == l1)

    l1 = []
    l1.append(cheltuiala1)
    assert(sterge_cheltuiala_dupa_zi(l, 0, 10, 0) == l1)

    try:
        zi = 9
        sterge_cheltuiala_dupa_zi(l, 0, zi, 0)
        assert(False)
    except Exception as ex:
...
def test_stergere_cheltuieli_dupa_zi_si_tip():
    ...
    try:
        z = 15
        t = "mancare"
        sterge_cheltuiala_dupa_zi_si_tip(l, z, t)
        assert(False)
    except Exception as ex:
        assert(str(ex) == "Lista de cheltuieli este goala!\n")
...
def test_stergere_cheltuieli_din_interval():
    ...
    l1 = []
    l1.append(cheltuiala)
    assert(sterge_cheltuiala_din_interval(l, 0, 10, 20, 0) == l1)

    l1 = []
    l1.append(cheltuiala)
    l1.append(cheltuiala1)
    assert(sterge_cheltuiala_din_interval(l, 0, 13, 23, 0) == l1)

    l1 = []
    l1.append(cheltuiala1)
    l1.append(cheltuiala2)
    assert(sterge_cheltuiala_din_interval(l, 0, 5, 10, 0) == l1)

    l1 = []
    l1.append(cheltuiala)
    l1.append(cheltuiala2)
    assert(sterge_cheltuiala_din_interval(l, 0, 10, 19, 0) == l1)

    try:
        prima_zi = 25
        ultima_zi = 29
        sterge_cheltuiala_din_interval(l, 0, prima_zi, ultima_zi, 0)
        assert(False)
    except Exception as ex:
...
def test_stergere_cheltuieli_de_un_anumit_tip():
    ...
    l1 = []
    l1.append(cheltuiala)
    assert(sterge_cheltuiala_de_un_anumit_tip(l, 0, "mancare", 0) == l1)

    l1 = []
    l1.append(cheltuiala1)
    l1.append(cheltuiala2)
    assert(sterge_cheltuiala_de_un_anumit_tip(l, 0, "intretinere", 0) == l1)

    try:
        tip = "gaz"
        sterge_cheltuiala_de_un_anumit_tip(l, 0, tip, 0)
        assert(False)
    except Exception as ex:
...
def test_undo():
    ...
    l1 = []
    istoric = []
    cheltuiala = creeaza_cheltuiala(12, 34, "mancare")
    cheltuiala1 = creeaza_cheltuiala(16, 45, "divertisment")
    cheltuiala2 = creeaza_cheltuiala(21, 39, "telefonie")
    cheltuiala3 = creeaza_cheltuiala(25, 75, "gaz")

    srv_adauga_cheltuiala(l,istoric,12, 34, "mancare",2)
    srv_adauga_cheltuiala(l,istoric,16, 45, "divertisment",2)
    srv_adauga_cheltuiala(l,istoric,21, 39, "telefonie",2)
    srv_adauga_cheltuiala(l,istoric,25, 75, "gaz",2)

    l1.append(cheltuiala)
    l1.append(cheltuiala1)
    l1.append(cheltuiala2)
    
    assert(undo(istoric,l) == l1)

    l = modificare_zi(l,istoric,25,29,"gaz",2)
    l = modificare_suma(l,istoric,29,30,"gaz",2)
    l = modificare_tip(l,istoric,29,"televiziune","gaz",2)

    cheltuiala3_1 = creeaza_cheltuiala(29, 30, "gaz")
    l1.append(cheltuiala3_1)

    assert(undo(istoric,l) == l1)

    l = undo(istoric,l)
    istoric = sterge_ultima_inregistrare_din_istoric(istoric)
    l1 = sterge_cheltuiala_dupa_zi_si_tip(l1,29,"gaz")

    cheltuiala3_2 = creeaza_cheltuiala(29, 75, "gaz")
    l1.append(cheltuiala3_2)
    ...
    l = sterge_cheltuiala_dupa_zi(l,istoric,21,2)
    l1 = sterge_cheltuiala_dupa_zi_si_tip(l1,21,"telefonie")
    l1.append(cheltuiala2)
    ...
    l = sterge_cheltuiala_din_interval(l,istoric, 10, 20, 2)
    l1 = sterge_cheltuiala_dupa_zi_si_tip(l1,12,"mancare")
    l1 = sterge_cheltuiala_dupa_zi_si_tip(l1,16,"divertisment")
    l1.append(cheltuiala1)
    ...
    l = sterge_cheltuiala_de_un_anumit_tip(l,istoric,"gaz",2)
    l1 = sterge_cheltuiala_dupa_zi_si_tip(l1,25,"gaz")
    l1.append(cheltuiala3)
