...
from validare import validare_cheltuiala
...
def adauga_cheltuiala(l, cheltuiala):
    ...
    for cheltuiala_locala in l:
        if (comparare(cheltuiala_locala["ziua"], cheltuiala["ziua"]) == True) and (comparare(cheltuiala_locala["tip"], cheltuiala["tip"]) == True):
