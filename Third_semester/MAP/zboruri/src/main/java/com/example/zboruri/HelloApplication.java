...
public class HelloApplication extends Application {
    ClientRepository repo_clienti=new ClientRepository("jdbc:postgresql://localhost:5432/zboruri","postgres","postgres");
    FlightRepository repo_zboruri=new FlightRepository("jdbc:postgresql://localhost:5432/zboruri","postgres","postgres");
    TicketRepository repo_bilete=new TicketRepository("jdbc:postgresql://localhost:5432/zboruri","postgres","postgres");
