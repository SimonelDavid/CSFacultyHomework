...
import org.example.protobuf.ProtoProjectProxy;

import java.io.IOException;
import java.util.Properties;

public class StartClientProto extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        try {
            clientProperties.load(StartClientProto.class.getResourceAsStream("/project_client.properties"));
        } catch (IOException e) {
            return;
        }
        ...
        IProjectServices server = new ProtoProjectProxy(serverIP, serverPort);
