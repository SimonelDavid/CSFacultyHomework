...
import domain.*;
import examen.network.utils.AbstractServer;
import examen.network.utils.RpcConcurrentServer;
import examen.network.utils.ServerException;
import examen.server.ServicesImpl;
...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        IPlayerRepository<Integer, Jurry> playerRepository = new PlayerDBIRepository(serverProps);
        IGameRepository<Integer, Game> gameRepository = new GameORMDBIRepository();
        IPositionRepository<Integer, Participant> positionRepository = new PositionORMDBIRepository();
        IScoreRepository<Integer, Rezultat> scoreRepository = new ScoreDBIRepository(serverProps,playerRepository, gameRepository, positionRepository);
