...
public class ClientRpcReflectionWorker implements Runnable, IObserver {
    ...
    private Response handleLOGIN(Request request) {
        ...
        Jurry game = (Jurry) request.data();
        try {
            Jurry foundGame = service.login(game, this);
...
//        try {
//            String result = service.participant(player_coordinates);
...
//        Jurry jurry = (Jurry) request.data();
//        try {
//            String control = service.setControlGameOver(jurry);
...
//    @Override
//    public void updateControl(Jurry jurry) {
//        Response resp = new Response.Builder().type(ResponseType.CONTROL).data(jurry).build();
